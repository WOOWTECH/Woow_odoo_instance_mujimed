...
![OpenClaw Console 主畫面](images/oc_01_main_chat.png)
...
#### 流程說明
![內容生產線流程](images/ch01_02_content-pipeline.png)
...
![K8s Pods 狀態](images/ch03_01_k8s-pods.png)
...
![K8s Services 列表](images/ch03_02_k8s-services.png)
...
![K8s Services](images/ch03_02_k8s-services.png)
...
![OpenClaw Instances](images/oc_05_instances.png)
...
![ConfigMaps](images/ch03_05_configmaps.png)

![Secrets](images/ch03_06_secrets.png)
...
![OpenClaw Agent 列表](images/oc_08_agents.png)

![OpenClaw Channel 選擇](images/oc_ch_main.png)
...
![OpenClaw Sessions](images/oc_06_sessions.png)
...
#### OpenClaw Console 各功能頁面一覽

以下截圖展示 OpenClaw Console 的主要功能頁面：

| 功能 | 說明 | 截圖 |
|------|------|------|
| Overview | 系統總覽儀表板 | ![Overview](images/oc_03_overview.png) |
| Channels | 通訊頻道列表 | ![Channels](images/oc_04_channels.png) |
| Instances | 已連線實例 | ![Instances](images/oc_05_instances.png) |
| Sessions | 對話 Sessions | ![Sessions](images/oc_06_sessions.png) |
| Usage | Token 用量統計 | ![Usage](images/oc_07_usage.png) |
| Agents | Agent 列表 | ![Agents](images/oc_08_agents.png) |
| Skills | Agent Skills | ![Skills](images/oc_09_skills.png) |
| Nodes | Agent Nodes | ![Nodes](images/oc_10_nodes.png) |
| Config | 系統配置 | ![Config](images/oc_11_config.png) |
| Automation | 自動化規則 | ![Automation](images/oc_12_automation.png) |
| Infrastructure | 基礎設施管理 | ![Infrastructure](images/oc_13_infrastructure.png) |
| AI & Agents | AI 模型設定 | ![AI & Agents](images/oc_14_ai_agents.png) |
| Debug | 偵錯工具 | ![Debug](images/oc_15_debug.png) |
| Logs | 系統日誌 | ![Logs](images/oc_16_logs.png) |


#### OpenClaw 對話頻道截圖

以下為 OpenClaw Console 中的對話頻道截圖，可直接與 Agent 進行即時對話：

![main 頻道](images/oc_ch_main.png)

> 透過切換頻道下拉選單，可以選擇不同的 Agent Channel 進行一對一對話。每個 Issue 也會自動建立獨立的 Channel。

### 步驟 6：Cloudflare Tunnel 路由


![Cloudflare Tunnel 配置](images/ch03_03_cloudflare-tunnel.png)
...
![資料庫表格列表](images/ch03_04_database-architecture.png)
...
![Dashboard 總覽](images/ch04_03_dashboard_overview.png)
...
![Inbox 通知中心](images/ch04_05_inbox.png)
...
![Agent 列表頁面](images/ch05_01_agent_list.png)
...
![Agent 詳情頁面](images/ch05_02_agent_detail_top.png)
...
![Instructions 頁面](images/ch05_m1_instructions.png)
...
![Adapter 配置欄位](images/ch05_07_adapter_config_fields.png)
...
<details>
<summary>展開查看所有 Agent 的 Runs 歷史</summary>

| Agent | Runs 歷史 |
|-------|-----------|
| M1 總編輯長 | ![M1 Runs](images/ch05_m1_runs.png) |
| M2 內容主編 | ![M2 Runs](images/ch05_m2_runs.png) |
| M3 營運主編 | ![M3 Runs](images/ch05_m3_runs.png) |
| R1 政策法規 | ![R1 Runs](images/ch05_r1_runs.png) |
| R2 企業案例 | ![R2 Runs](images/ch05_r2_runs.png) |
| R3 數據趨勢 | ![R3 Runs](images/ch05_r3_runs.png) |
| R4 國際掃描 | ![R4 Runs](images/ch05_r4_runs.png) |
| R5 台灣在地 | ![R5 Runs](images/ch05_r5_runs.png) |
| W1 新聞記者 | ![W1 Runs](images/ch05_w1_runs.png) |
| W2 教師風 | ![W2 Runs](images/ch05_w2_runs.png) |
| W3 學術分析 | ![W3 Runs](images/ch05_w3_runs.png) |
| W4 說故事 | ![W4 Runs](images/ch05_w4_runs.png) |
| W5 意見領袖 | ![W5 Runs](images/ch05_w5_runs.png) |
| W6 數據新聞 | ![W6 Runs](images/ch05_w6_runs.png) |
| W7 簡潔速讀 | ![W7 Runs](images/ch05_w7_runs.png) |
| Q1 品質審查 | ![Q1 Runs](images/ch05_q1_runs.png) |
...
### 步驟 2：建立新 Issue
![新增 Issue 表單](images/ch06_02_new_issue_form.png)
...
### 步驟 3：指派 Agent
![Issue 詳情 — Agent 回覆](images/ch06_issue_detail_1.png)
...
![Issue 生命週期](images/ch06_04_issue_lifecycle.png)
...
![Agent 回覆 — Issue 詳情](images/ch06_issue_detail_1.png)

![Agent 回覆 — Comment](images/ch06_issue_comments_2.png)
...
<details>
<summary>展開查看 Issue 詳情截圖</summary>

| Issue | 描述 | 截圖 |
|-------|------|------|
| CMP-146 | M3 排程 Issue | ![CMP-146](images/ch06_issue_146_top.png) |
| CMP-135 | W1 碳費新聞 | ![CMP-135](images/ch06_issue_135_top.png) |
| CMP-144 | Q1 退回測試 | ![CMP-144](images/ch06_issue_144_top.png) |
| CMP-134 | R5 台灣動態 | ![CMP-134](images/ch06_issue_134_top.png) |
| CMP-148 | R3 測試 | ![CMP-148](images/ch06_issue_148_top.png) |
| CMP-147 | W4 測試 | ![CMP-147](images/ch06_issue_147_top.png) |
| CMP-149 | Q2 測試 | ![CMP-149](images/ch06_issue_149_top.png) |

**Agent 回覆 Comment 範例：**

![Agent Comment 範例 1](images/ch06_issue_comments_2.png)

![Agent Comment 範例 2](images/ch06_issue_comments_3.png)
...
![Issue 列表與篩選](images/ch06_01_issue_list.png)
...
![Routines 列表](images/ch07_01_routines_list.png)
...
![Goals 目標管理](images/ch07_04_goals_list.png)
...
![總編輯長 — Agent 詳情](images/ch05_m1_detail.png)


![總編輯長 — Instructions](images/ch05_m1_instructions.png)
...
![內容主編 — Agent 詳情](images/ch05_m2_detail.png)
...
![M1 Agent Settings](images/ch05_m1_settings.png)
...
![營運主編 — Agent 詳情](images/ch05_m3_detail.png)


![營運主編 — Instructions](images/ch05_m3_instructions.png)


![營運主編 — Runs 歷史](images/ch05_m3_runs.png)
...
![M3 Agent Settings](images/ch05_m3_settings.png)
...
![政策法規研究員 — Runs 歷史](images/ch05_r1_runs.png)


![政策法規研究員 — Agent 詳情](images/ch05_r1_detail.png)
...
![企業案例研究員 — Runs 歷史](images/ch05_r2_runs.png)


![企業案例研究員 — Agent 詳情](images/ch05_r2_detail.png)


![企業案例研究員 — Instructions](images/ch05_r2_instructions.png)
...
![數據趨勢研究員 — Runs 歷史](images/ch05_r3_runs.png)


![數據趨勢研究員 — Agent 詳情](images/ch05_r3_detail.png)


![數據趨勢研究員 — Instructions](images/ch05_r3_instructions.png)
...
![國際媒體掃描員 — Runs 歷史](images/ch05_r4_runs.png)


![國際媒體掃描員 — Agent 詳情](images/ch05_r4_detail.png)


![國際媒體掃描員 — Instructions](images/ch05_r4_instructions.png)
...
![台灣在地線人 — Runs 歷史](images/ch05_r5_runs.png)


![台灣在地線人 — Instructions](images/ch05_r5_instructions.png)
...
![新聞記者風 — Runs 歷史](images/ch05_w1_runs.png)


![新聞記者風 — Agent 詳情](images/ch05_w1_detail.png)


![新聞記者風 — Instructions](images/ch05_w1_instructions.png)
...
![W1 Agent Settings](images/ch05_w1_settings.png)
...
![知識型教師風 — Runs 歷史](images/ch05_w2_runs.png)


![知識型教師風 — Agent 詳情](images/ch05_w2_detail.png)


![知識型教師風 — Instructions](images/ch05_w2_instructions.png)
...
![W2 Agent Settings](images/ch05_w2_settings.png)
...
![學術分析師風 — Runs 歷史](images/ch05_w3_runs.png)


![學術分析師風 — Agent 詳情](images/ch05_w3_detail.png)


![學術分析師風 — Instructions](images/ch05_w3_instructions.png)
...
![W3 Agent Settings](images/ch05_w3_settings.png)
...
![說故事風 — Agent 詳情](images/ch05_w4_detail.png)


![說故事風 — Instructions](images/ch05_w4_instructions.png)
...
![W4 Agent Settings](images/ch05_w4_settings.png)
...
![意見領袖風 — Runs 歷史](images/ch05_w5_runs.png)


![意見領袖風 — Agent 詳情](images/ch05_w5_detail.png)


![意見領袖風 — Instructions](images/ch05_w5_instructions.png)
...
![W5 Agent Settings](images/ch05_w5_settings.png)
...
![數據新聞風 — Runs 歷史](images/ch05_w6_runs.png)


![數據新聞風 — Agent 詳情](images/ch05_w6_detail.png)


![數據新聞風 — Instructions](images/ch05_w6_instructions.png)
...
![W6 Agent Settings](images/ch05_w6_settings.png)
...
![簡潔速讀風 — Runs 歷史](images/ch05_w7_runs.png)


![簡潔速讀風 — Agent 詳情](images/ch05_w7_detail.png)


![簡潔速讀風 — Instructions](images/ch05_w7_instructions.png)
...
![W7 Agent Settings](images/ch05_w7_settings.png)
...
![Q1 內容品質審查員 — Agent 詳情](images/ch05_q1_detail.png)

![Q1 Instructions](images/ch05_q1_instructions.png)
...
![Q1/Q2 雙重審查流程](images/ch11_03_dual_review_flow.png)
...
![Odoo 登入頁面](images/odoo_01_login_page.png)
...
![Odoo 專案 Kanban](images/odoo_04_project_kanban.png)
...
![Odoo ESGTimes 專案任務](images/odoo_05_first_project.png)
...
![Odoo 專案 Kanban 看板](images/odoo_04_project_kanban.png)
...
![Odoo 專案 Kanban 總覽](images/odoo_04_project_kanban.png)

![Odoo 任務表單](images/odoo_06_task_form.png)

![Odoo 任務 Chatter 訊息](images/odoo_07_task_chatter.png)
...
![建立研究任務 Issue](images/ch06_issue_146_top.png)
...
![R5 研究成果](images/ch06_issue_134_top.png)
...
![Issue 詳情 — 企業故事報導](images/ch06_issue_detail_3.png)
...
![Issue 詳情 — 數據新聞](images/ch06_issue_detail_4.png)
...
![退回場景 — Q1 退回 Issue](images/ch06_issue_144_comments.png)
...
![Agent 狀態 DB 查詢](images/ch14_02_agent_status_query.png)
...
![Gateway 日誌輸出](images/ch14_03_gateway_logs.png)
...
![Runs DB 查詢](images/ch14_08_runs_db.png)
...
![OpenClaw AI & Agents 設定](images/oc_14_ai_agents.png)
...
![OpenClaw Infrastructure](images/oc_13_infrastructure.png)

#### 1:1 Workspace 架構


![OpenClaw Channels](images/oc_04_channels.png)
...
![OpenClaw Console Overview](images/oc_03_overview.png)
...
![OpenClaw Chat — main channel](images/oc_ch_main.png)
...
![OpenClaw Config](images/oc_11_config.png)
...
![Issues DB 查詢](images/ch14_07_issues_db.png)
...
![OpenClaw Debug 頁面](images/oc_15_debug.png)
...
![Paperclip Logs](images/ch14_06_paperclip_logs.png)
...
![OpenClaw Usage 統計](images/oc_07_usage.png)
...
![Issue 列表 — 測試結果](images/ch06_01_issue_list.png)

![Agent 狀態查詢結果](images/ch14_02_agent_status_query.png)
...
![OpenClaw Logs](images/oc_16_logs.png)
